...
50%.Also the user has the ability to view the history of all his grades by grade level in graphs based
on scoring and date. Each level has different tets from random questions which refers at the level that 
user choose. Finally, if all tests are passed, a user is certified and can view his name and date issue
